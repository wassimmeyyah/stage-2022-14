...
<div class="container">
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="btn-group">
            <p align="center">
                <a class="btn btn-light text-primary " type="button" href="{{route('goPersonnelacadMail')}}">Contacts des personnes</a>
                @can('create-users')
                ...
                <div class="card flex-md-row mb-4 box-shadow h-md-250" style="width: 204%">
                    <div class="card-body d-flex flex-column align-items-start">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            @can('updateDelete-users')
                            <td>
                                <a href="#" class="btn btn-light text-primary" type="button" onclick="if(confirm('Voulez-vous vraiment supprimer cette personne ?')){document.getElementById('{{$personnelacad->PACode}}').submit() }">
                                    Supprimer
