                        ...
                        <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <body class="text-center">
                                ...
                                <form action="{{route('goPorteurRecherche')}}" class="form-signin">
                                    ...
                                    <button  class="btn btn-light text-primary mb-3  "><i class="bi bi-search"> Rechercher un porteur </i></button>


                                </form>

                                <a  class="btn btn-danger " href="{{route('goPorteur')}}">Afficher tous les porteurs</a>
