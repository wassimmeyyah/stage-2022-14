...
<form action="" class=" d-flex mr-3">
    ...
    <div class="form-group mr-3 d-flex justify-content-end p-2">
        ...
        <select name ="s" id="filtreThematique" wire:model="filtreThematique" style="min-width:110px;">
            <option name="s" class="form-control" value=""></option>
            <option name="s" class="form-control" value="ECL">Ecole</option>
            <option name="s" class="form-control" value="CLG">College</option>
            <option name="s" class="form-control" value="LYC">Lycée</option>
        </select>
    </div>
