        ...
        <x-app-layout>
            <x-slot name="header">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">
                    {{ __('Les expérimentations triées') }}
                </h2>
            </x-slot>
                        ...
                        <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <body class="text-center">
                                ...
                                <form action="{{route('goExperimentationRecherche')}}" class="form-signin">
                                    ...
                                    <button  class="btn btn-light text-primary mb-3  "><i class="bi bi-search"> Rechercher une experimentation </i></button>


                                </form>

                                <a  class="btn btn-danger " href="{{route('goExperimentation')}}">Afficher toutes les experimentations</a>
