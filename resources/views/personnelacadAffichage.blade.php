                                        ...
                                        <div class="col-md-8 blog-main">
                                            ...
                                            <div class="blog-post">
                                                ...
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-danger"  onclick="if(confirm('Voulez-vous vraiment supprimer ce personnelacad ?')){document.getElementById('{{$personnelacad->PACode}}').submit() }">
                                                            Supprimer
